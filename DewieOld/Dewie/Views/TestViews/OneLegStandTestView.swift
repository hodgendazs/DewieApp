...
#Preview {
    MainActor.assumeIsolated {
        ...
        return OneLegStandTestView(currentOfficer: .constant(.previewOfficer), caseNumber: "24-1111", dateTime: Date().formatted(date: .abbreviated, time: .shortened), oneLegStandTestComplete: .constant(false), oneLegStandTestResults: .constant(nil))
