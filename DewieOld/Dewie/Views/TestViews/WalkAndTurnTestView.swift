...
struct WalkAndTurnTestView: View {
    ...
    var body: some View {
        ...
        .onChange(of: submitWalkAndTurn) {
            ...
            walkAndTurnTestResults = Report.WalkAndTurn(startsTooSoon: startsTooSoon, cannotRemainInStartingPosition: cannotRemainInStartingPosition, stepsOffLine: stepsOffLine, missesHeelToToe: missesHeelToToe, raisesArmForBalance: raisesArmForBalance, stops: stops, incorrectNumberOfSteps: incorrectNumberOfSteps, numberOfIncorrectSteps: numberOfIncorrectSteps, turnNotAsDescribed: turnNotAsDescribed, improperTurnDescription: improperTurnDescription, walkAndTurnNotes: walkAndTurnNotes)
...
#Preview {
    MainActor.assumeIsolated {
        ...
        return WalkAndTurnTestView(currentOfficer: .constant(.previewOfficer), caseNumber: "24-1111", dateTime: Date().formatted(date: .abbreviated, time: .shortened), walkAndTurnTestComplete: .constant(false), walkAndTurnTestResults: .constant(nil))
