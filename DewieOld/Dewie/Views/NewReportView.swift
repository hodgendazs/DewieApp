                    ...
                    Form {
                        Section(header: Text("Tests Available")) {
                            ...
                            HStack {
                                Spacer()
                                Button {
                                    currentOfficer.addReport(caseNumber: caseNumber, officerId: currentOfficer.id, hgnTestResults: hgnTestResults, walkAndTurnTestResults: walkAndTurnTestResults, oneLegStandResults: oneLegStandTestResults)
                                ...
                                .navigationDestination(isPresented: $reportSubmitted) {
                                    HomeScreen(currentOfficer: currentOfficer)
